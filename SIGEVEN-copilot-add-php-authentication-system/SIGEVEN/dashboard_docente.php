<?php
/**
 * Archivo: dashboard_docente.php
 * Descripción: Panel para docentes
 * Ubicación: C:\xampp\htdocs\SIGEVEN\dashboard_docente.php
 */
...
<head>
    ...
    <title>Dashboard Docente - SIGEVEN</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="dashboard-container">
        <div class="header">
            <h1>SIGEVEN - Panel de Docente</h1>
