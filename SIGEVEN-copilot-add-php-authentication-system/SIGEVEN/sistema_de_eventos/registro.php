...
<body>
    ...
    <div id="main" class="auth-container">
      <div class="login-form">
        ...
        <div class="auth-links">
          <p>
            ¿Ya tienes cuenta? 
            <a href="loginDocente.php"><span class="material-symbols-outlined" style="font-size: 1rem;">login</span>Iniciar Sesión</a>
          </p>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    function selectUserType(tipo) {
      ...
      showToast(`Tipo de usuario: ${tipoNombres[tipo]}`, 'info');
