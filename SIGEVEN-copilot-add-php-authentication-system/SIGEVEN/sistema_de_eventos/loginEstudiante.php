      ...
      <div id="main" class="auth-container">
        <div class="login-form">
          <div class="form-header">
            <h1><span class="material-symbols-outlined" style="vertical-align: middle; font-size: 2rem; margin-right: 8px;">person</span>Acceso Estudiantes</h1>
          ...
          <form action="php/login.php" method="POST" id="loginForm">
            ...
            <div class="form-group">
              <label for="username"><span class="material-symbols-outlined" style="vertical-align: middle; font-size: 18px;">badge</span> Código de Estudiante</label>
              <input
                type="text"
                id="username"
                name="username"
          ...
          <div class="auth-links">
            <p>
              ¿Eres docente?
              <a href="loginDocente.php"><span class="material-symbols-outlined" style="font-size: 16px; vertical-align: middle;">school</span> Acceso para docentes</a>
            </p>
            <p>
              ¿No tienes cuenta?
