<?php
/**
 * Archivo: dashboard_estudiante.php
 * Descripción: Panel para estudiantes
 * Ubicación: C:\xampp\htdocs\SIGEVEN\dashboard_estudiante.php
 */
...
<head>
    ...
    <title>Dashboard Estudiante - SIGEVEN</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="dashboard-container">
        <div class="header">
            <h1>SIGEVEN - Panel de Estudiante</h1>
